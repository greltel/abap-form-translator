" ZCL_FORM_TRANS_RULES - Test Classes
...
CLASS ltc_rules IMPLEMENTATION.
  ...
  METHOD given_no_target_then_rejected.
    ...
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = field source = 'E' target = VALUE #( ) )
                          ambiguous = VALUE #( )
                          occupied  = VALUE #( ) ).
  ...
  METHOD given_same_lang_then_rejected.
    " --- ACT
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = field source = 'E' target = 'E' )
                          ambiguous = VALUE #( )
                          occupied  = VALUE #( ) ).
  ...
  METHOD given_key_taken_then_rejected.
    ...
    " --- ACT
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = field source = 'D' target = 'E' )
                          ambiguous = VALUE #( )
                          occupied  = occupied ).
  ...
  METHOD given_free_lang_then_ok.
    ...
    " --- ACT
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = field source = 'E' target = 'D' )
                          ambiguous = VALUE #( )
                          occupied  = occupied ).
  ...
  METHOD given_other_field_then_ok.
    ...
    " --- ACT
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = 'FOOTER' source = 'D' target = 'E' )
                          ambiguous = VALUE #( )
                          occupied  = occupied ).
  ...
  METHOD given_ambiguous_then_rejected.
    ...
    " --- ACT
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = field source = 'E' target = 'G' )
                          ambiguous = ambiguous
                          occupied  = VALUE #( ) ).
  ...
  METHOD given_ambig_other_then_ok.
    ...
    " --- ACT
    DATA(rejection) = zcl_form_trans_rules=>check_copy_request(
                          request   = request( fieldname = 'FOOTER' source = 'E' target = 'G' )
                          ambiguous = ambiguous
                          occupied  = VALUE #( ) ).
